...
class GoBGPTestBase(unittest.TestCase):
    ...
    def test_02_add_del_mup_route(self):
        tests = [
                ...
                ('mup_t2st_route_ipv4', 'ipv4-mup', 't2st 10.0.0.1 rd 100:100 rt 10:10 teid 12345 mup 10:10 nexthop 10.0.0.2', '10.0.0.2'),
                ...
                ('mup_t2st_route_ipv6', 'ipv6-mup', 't2st 2001::1 rd 100:100 rt 10:10 teid 12345 mup 10:10 nexthop 10.0.0.2', '10.0.0.2'),
                ]
