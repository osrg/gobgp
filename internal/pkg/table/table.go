...
func newTablePartial(logger log.Logger, rf bgp.RouteFamily, isAdj bool, dsts ...*Destination) *Table {
	t := &Table{
		routeFamily:  rf,
...
func NewAdjTable(logger log.Logger, rf bgp.RouteFamily, dsts ...*Destination) *Table {
