...
// rtIndex is used for saving map[rt]->{rtState} in global tables and saving lists of routes
// to answer RTC requests.
// It must register all not-RTC paths that are added to the Table (currently the only place is
