...
You can write condition and action under StatementList.
 ...
 | Element | Description                                                                      | Example |
 |---------|----------------------------------------------------------------------------------|---------|
 | SetMed  | SetMed used to change the med value of the route. <br> If only numbers have been specified, replace the med value of route.<br> if number and operater(+ or git s-) have been specified, adding or subtracting the med value of route. | "-200"    |
