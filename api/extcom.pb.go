...
var file_extcom_proto_rawDesc = string([]byte{
	...
	0x6f, 0x6d, 0x2f, 0x6f, 0x73, 0x72, 0x67, 0x2f, 0x67, 0x6f, 0x62, 0x67, 0x70, 0x2f, 0x76, 0x34,
...
var (
	...
	file_extcom_proto_rawDescData []byte
)

func file_extcom_proto_rawDescGZIP() []byte {
	file_extcom_proto_rawDescOnce.Do(func() {
		file_extcom_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_extcom_proto_rawDesc), len(file_extcom_proto_rawDesc)))
	})
	return file_extcom_proto_rawDescData
}

var file_extcom_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
var file_extcom_proto_goTypes = []any{
...
func file_extcom_proto_init() {
	...
	file_extcom_proto_msgTypes[22].OneofWrappers = []any{
	...
	file_extcom_proto_msgTypes[23].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_extcom_proto_rawDesc), len(file_extcom_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   24,
			NumExtensions: 0,
			NumServices:   0,
