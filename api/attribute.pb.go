...
type SRv6BindingSID struct {
	...
	EndpointBehaviorStructure *SRv6EndPointBehavior `protobuf:"bytes,5,opt,name=endpoint_behavior_structure,json=endpointBehaviorStructure" json:"endpoint_behavior_structure,omitempty"`
}
...
type SegmentTypeB struct {
	...
	EndpointBehaviorStructure *SRv6EndPointBehavior `protobuf:"bytes,3,opt,name=endpoint_behavior_structure,json=endpointBehaviorStructure" json:"endpoint_behavior_structure,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
	...
	0xdf, 0x08, 0x0e, 0xa8, 0x5b, 0x50, 0x32, 0x09, 0xc1, 0x8e, 0x87, 0x6c, 0x21, 0x59, 0x0c, 0x6b,
	0x47, 0x70, 0xe3, 0x32, 0xc7, 0x78, 0xd3, 0x59, 0x86, 0x8b, 0x6f, 0xc3, 0xf0, 0x3b, 0xb8, 0x75,
	...
	0xc0, 0xc8, 0xb4, 0xa4, 0x15, 0xdd, 0x02, 0xc0, 0x41, 0x3c, 0x3e, 0xc7, 0xc6, 0x17, 0x71, 0x20,
	0x87, 0x93, 0x3b, 0x35, 0x9f, 0xbe, 0x53, 0xda, 0x3f, 0xe6, 0xe0, 0x3e, 0xdd, 0x77, 0xdb, 0xb3,
	0xdc, 0x31, 0xc1, 0x13, 0xc4, 0x1c, 0xa5, 0x65, 0x92, 0xa8, 0x95, 0xac, 0xfe, 0x2e, 0x2a, 0x98,
	0xde, 0x4b, 0xfe, 0xf2, 0x5e, 0xb2, 0xa2, 0x16, 0xa6, 0x44, 0xd5, 0xfe, 0x29, 0x07, 0x1b, 0x69,
	0x1b, 0x92, 0xee, 0xff, 0xa7, 0x3f, 0x87, 0x37, 0x08, 0xf6, 0xbb, 0x3c, 0x2c, 0x33, 0x5d, 0xf5,
	0xb8, 0xa3, 0xfa, 0x30, 0x2c, 0xe3, 0x06, 0x2c, 0xe2, 0xc0, 0x10, 0x9e, 0x8f, 0xdb, 0x45, 0x09,
	0x07, 0xc2, 0x95, 0x6a, 0x50, 0x8d, 0x07, 0x99, 0xd7, 0x9c, 0xe3, 0x0c, 0x24, 0x01, 0xf5, 0x9b,
	...
	,
	...
	,
	...
	0x06, 0xc5, 0x68, 0x7f, 0xc8, 0xc1, 0x8d, 0x76, 0x6f, 0xb2, 0x2f, 0x72, 0xbb, 0x1f, 0x5d, 0xa0,
