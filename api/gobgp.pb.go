...
type AsPrependAction struct {
	...
	OpAction    uint32   `protobuf:"varint,5,opt,name=op_action,json=opAction" json:"op_action,omitempty"`
}
...
func (x *AsPrependAction) GetAsns() []uint32 {
	if x != nil {
		return x.Asns
	}
	return nil
...
func (x *AsPrependAction) GetOpAction() uint32 {
	if x != nil {
		return x.OpAction
	}
	return 0
