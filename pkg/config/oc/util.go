...
func NewPeerFromConfigStruct(pconf *Neighbor) *api.Peer {
	...
	return &api.Peer{
		...
		Conf: &api.PeerConf{
			...
			IncomingChannelTimeout: pconf.Config.IncomingChannelTimeout,
			IncomingChannel: &api.ChannelConfig{
				Type: api.ChannelType(pconf.Config.IncomingChannel.ChannelType.ToInt()),
				Size: pconf.Config.IncomingChannel.Size,
			},
			OutgoingChannelTimeout: pconf.Config.OutgoingChannelTimeout,
			OutgoingChannel: &api.ChannelConfig{
				Type: api.ChannelType(pconf.Config.OutgoingChannel.ChannelType.ToInt()),
				Size: pconf.Config.OutgoingChannel.Size,
			},
		},
		State: &api.PeerState{
			...
			Flops:                  s.Flops,
			IncomingChannelDropped: pconf.State.IncomingChannelDropped,
			IncomingChannel: &api.ChannelState{
				In:            pconf.State.IncomingChannelState.ChannelState.In,
				Notifications: pconf.State.IncomingChannelState.ChannelState.Notifications,
				Collected:     pconf.State.IncomingChannelState.ChannelState.Collected,
				Rewritten:     pconf.State.IncomingChannelState.ChannelState.Rewritten,
				Retries:       pconf.State.IncomingChannelState.ChannelState.Retries,
				Out:           pconf.State.IncomingChannelState.ChannelState.Out,
			},
			OutgoingChannelDropped: pconf.State.OutgoingChannelDropped,
			OutgoingChannel: &api.ChannelState{
				In:            pconf.State.OutgoingChannelState.ChannelState.In,
				Notifications: pconf.State.OutgoingChannelState.ChannelState.Notifications,
				Collected:     pconf.State.OutgoingChannelState.ChannelState.Collected,
				Rewritten:     pconf.State.OutgoingChannelState.ChannelState.Rewritten,
				Retries:       pconf.State.OutgoingChannelState.ChannelState.Retries,
				Out:           pconf.State.OutgoingChannelState.ChannelState.Out,
			},
		},
