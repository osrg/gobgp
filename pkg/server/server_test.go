...
func waitState(s *BgpServer, ch chan struct{}, state api.PeerState_SessionState, expectedFamilies ...bgp.RouteFamily) {
...
func waitEstablishedWithFamilies(s *BgpServer, ch chan struct{}, rfs ...bgp.RouteFamily) {
