...
func bmpPeerDown(ev *watchEventPeer, t uint8, policy bool, pd uint64) *bmp.BMPMessage {
	...
	case peering.FSMDying, peering.FSMInvalidMsg, peering.FSMNotificationSent, peering.FSMHoldTimerExpired, peering.FSMIdleTimerExpired, peering.FMSRestartTimerExpired:
