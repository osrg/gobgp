...
func IsTransitiveType(ec ExtendedCommunityInterface) bool {
	if ecType, _ := ec.GetTypes(); ecType < EC_TYPE_NON_TRANSITIVE_TWO_OCTET_AS_SPECIFIC {
		return true
	}
	return false
}

func SubTypeEqual(ec ExtendedCommunityInterface, st ExtendedCommunityAttrSubType) bool {
